...
pub struct AddMember {
  pub member_parameter: MemberParameter,
  pub tag: String,
}

impl AddMember {
  pub fn new(member_parameter: MemberParameter, tag: &str) -> Self {
    Self {
      member_parameter,
      tag: tag.to_owned(),
    }
