...
async fn api_call(
  ...
  let router = crate::router::Router::new()
    ...
    .handle("battleskip", quest::quest_main::battle_skip)
    .handle("quest_main_part_list", quest::quest_main::quest_main_part_list)
    .handle("quest_main_stage_list", quest::quest_main::quest_main_stage_list)
    .handle("quest_main_area_list", quest::quest_main::quest_main_area_list)
    .handle("questhuntinglist", quest::quest_hunting::quest_hunting_list)
    .handle("questhuntingstagelist", quest::quest_hunting::quest_hunting_stage_list)
    .handle("quest_hunting_limit_stage_list", quest::quest_hunting::quest_hunting_limit_stage_list)
    .handle("battlehuntingstart", quest::quest_hunting::battle_hunting_start)
    .handle("battlehuntingresult", quest::quest_hunting::battle_hunting_result)
    .handle("huntingquest_list_by_item", quest::quest_hunting::hunting_quest_list_by_item)
    .handle("battlehuntingskip", quest::quest_hunting::battle_hunting_skip)
    .handle("fame_quest_rank_list", quest::quest_fame::fame_quest_rank_list)
    .handle("fame_quest_area_list", quest::quest_fame::fame_quest_area_list)
    .handle("fame_quest_stage_list", quest::quest_fame::fame_quest_stage_list)
    .handle("fame_quest_start", quest::quest_fame::fame_quest_start)
    .handle("fame_quest_result", quest::quest_fame::fame_quest_result)
    ...
    .handle("marathon_single_start", battle::marathon_single_start)
    .handle("marathon_single_log", battle::marathon_single_log)
    .handle("marathon_single_result", battle::marathon_single_result)
